...
class Set2SetNet(pl.LightningModule):
	"""
	...
	"""
	def __init__(self, input_dim, embedding_dim, num_processing_steps: int, max_seq_len, lr=1e-3, wd=1e-5, num_layers=1, bidirectional=True, batch_first=True):
